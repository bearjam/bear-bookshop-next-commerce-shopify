...
export type GetCollectionProductsQuery = { __typename?: 'QueryRoot' } & {
...
export type ProductTagsQuery = { __typename?: 'QueryRoot' } & {
  productTags: { __typename?: 'StringConnection' } & {
    edges: Array<{ __typename?: 'StringEdge' } & Pick<StringEdge, 'node'>>
  }
}

export const ProductConnectionFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
...
} as unknown as DocumentNode<ProductConnectionFragment, unknown>
export const GetAllProductsDocument = {
  ...
  definitions: [
      ...
      variableDefinitions: [
        {
          ...
          defaultValue: { kind: 'IntValue', value: '150' },
        },
        {
          kind: 'VariableDefinition',
          variable: {
    ...
    ...ProductConnectionFragmentDoc.definitions,
  ],
...
>
export const ProductTagsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<ProductTagsQuery, ProductTagsQueryVariables>
